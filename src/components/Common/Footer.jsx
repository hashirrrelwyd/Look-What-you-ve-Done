      ...
      <footer className="bg-[#111111] text-white rounded-t-4xl px-6 md:px-10 pb-10">
        <div className="flex flex-col md:flex-row gap-10 pt-14 justify-between pb-4">
          <div className="flex flex-col gap-16">
            ...
            <div>
              <a onClick={()=> navigate("/")} onMouseEnter={() => setHoverType("button")} onMouseLeave={() => setHoverType("default")}>
                <img
            ...
            <div className="pb-10 flex gap-4 items-center">
              <p className="text-lwyd-yellow text-[14px] md:text-[15px] lg:text-[18px]" onMouseEnter={() => setHoverType("big-white")} onMouseLeave={() => setHoverType("default")}>
          ...
          <div className="">
            <div className="pb-4">
              <h2 onMouseEnter={() => setHoverType("big-white")} onMouseLeave={() => setHoverType("default")} className="text-lwyd-yellow text-[14px] md:text-[15px] lg:text-[18px]">
                /<span className="text-gray-400">Inquiries</span>
              </h2>
            </div>
            <ul className="text-[11px] md:text-[13px] lg:text-[16px]">
              <li>
                <a onMouseEnter={() => setHoverType("button")} onMouseLeave={() => setHoverType("default")}
              className="cursor-none" href="tel:+919677207522">+91 96772 07522</a>
              </li>
              <li>
                <a onMouseEnter={() => setHoverType("button")} onMouseLeave={() => setHoverType("default")}
              className="cursor-none" href="mailto:contact@lwyd.in">contact@lwyd.in</a>
              </li>
            </ul>
          </div>
          <div>
        ...
        <div className="text-[10px] md:text-[12px] lg:text-[13px]">
          <div className="flex md:flex-row flex-col justify-between items-center pt-10">
            <div>
              <p onMouseEnter={() => setHoverType("big-white")} onMouseLeave={() => setHoverType("default")}
              className="cursor-none">© 2025 LWYD Limited. All rights reserved.</p>
            </div>
            <div className="flex gap-10">
              <p onMouseEnter={() => setHoverType("button")} onMouseLeave={() => setHoverType("default")}
              >Privacy & Legal</p>
              <p onMouseEnter={() => setHoverType("button")} onMouseLeave={() => setHoverType("default")}
              >Term & Condition</p>
            </div>
